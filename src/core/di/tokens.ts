export const TOKENS = {
  ...
  GetAssessmentsByCourseUC: Symbol("GetAssessmentsByCourseUC"),
  GetAssessmentByIdUC: Symbol("GetAssessmentByIdUC"),
  CreateAssessmentUC: Symbol("CreateAssessmentUC"),
  UpdateAssessmentUC: Symbol("UpdateAssessmentUC"),
  DeleteAssessmentUC: Symbol("DeleteAssessmentUC"),
  ActivateAssessmentUC: Symbol("ActivateAssessmentUC"),
  CompleteAssessmentUC: Symbol("CompleteAssessmentUC"),
  CreatePeerEvaluationUC: Symbol("CreatePeerEvaluationUC"),
  GetPeerEvaluationsByAssessmentUC: Symbol("GetPeerEvaluationsByAssessmentUC"),
  GetPeerEvaluationsByEvaluatorUC: Symbol("GetPeerEvaluationsByEvaluatorUC"),
  GetPeerEvaluationsByEvaluatedUC: Symbol("GetPeerEvaluationsByEvaluatedUC"),
  GetPeerEvaluationByEvaluatorAndEvaluatedUC: Symbol("GetPeerEvaluationByEvaluatorAndEvaluatedUC"),
